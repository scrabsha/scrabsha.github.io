...
#let radio(id: none, name: none, value: none, content) = [
  #html.div[
    #html.input(type: "radio", name: name, value: value, id: id)
...
#let make(additional-header) = [
  ...
  #html.form(name: "page_settings")[
    #html.div(style: "display:flex;justify-content:center;align-items:center; flex-wrap: wrap")[
      #header-setting-element([Theme])[
        #radio(id: "dark-theme-radio", name: "theme", value: "dark")[🌒 Dark theme]
        #radio(id: "system-theme-radio", name: "theme", value: "system")[💻 System theme]
        #radio(id: "light-theme-radio", name: "theme", value: "light")[☀️ Light theme]

        #html.div[
          #html.input(type: "checkbox", id: "bw-toggle", name: "black_and_white")
      ...
      #additional-header
      #header-setting-element([Personalization])[
        #html.div[
